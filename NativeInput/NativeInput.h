...
namespace Native {
		...
		//void MouseMoveHandlerDelegate	();
		//void MouseScrollEventHandler	();
		//void KeyDownEventHandler		();
		//void KeyUpEventHandler			();
		//void KeyPressEventHandler		();
		////Keys key 
		//void AddPressedKey();
		////Keys key 
		//void RemovePressedKey ();
		////object sender, MouseInputEventArgs e
		//void MouseHandler (  );
		//// object sender, KeyboardInputEventArgs e 
		//void KeyboardHandle ();
